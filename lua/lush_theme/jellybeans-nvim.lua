...
local theme =
  ...
  function()
    return {
      ...
      -- TODO: extra groups to style
      IndentBlanklineChar {fg = line},
      -- NvimTree
      NvimTreeFolderIcon {},
      NvimTreeFolderName {},
      NvimTreeIndentMarker {},
      NvimTreeVertSplit {fg = grey_three, bg = background},
      NvimTreeRootFolder {},
      NvimTreeNormal {},
      ...
      -- regular lush colorscheme groups
      ...
      DiffAdd {fg = tea_green, bg = background}, -- diff mode: Added line |diff.txt|
      DiffChange {fg = calypso, bg = background}, -- diff mode: Changed line |diff.txt|
      DiffModified {fg = calypso, bg = background}, -- diff mode: Changed text within a changed line |diff.txt|
      DiffDelete {fg = temptress, bg = background}, -- diff mode: Deleted line |diff.txt|
      ...
      VertSplit {fg = gravel, bg = background}, -- the column separating vertically split windows
      Folded {fg = grey_chateau, bg = bright_grey}, -- line used for closed folds
      FoldColumn {fg = shuttle_grey, bg = mine_shaft}, -- 'foldcolumn'
      SignColumn {fg = background, bg = background}, -- column where |signs| are displayed
      ...
      CursorLineNr {fg = total_white}, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
